...
class CaloriesCalculator(Calculator):
    def get_calories_remained(self):
        ...
        if calories_remained > 0:
            a = (f'Сегодня можно съесть что-нибудь ещё', 
...
r2 = Record(amount=1545, comment='Корзина потр.', date='16.07.2020')
...
r4 = Record(amount=1500, comment='Кусок тортика.', date='16.07.2020')
